...
readonly REPO_URL="https://github.com/erffy-dots/fish.git"
...
echo "Downloading Fish configuration files from GitHub..."

# Handle existing configuration
if [ -d "$CONFIG_DIR" ]; then
    echo "Existing Fish configuration detected at '$CONFIG_DIR'."
...
echo "You may need to install additional dependencies for Fish."
echo "Refer to the Fish documentation for more information."
